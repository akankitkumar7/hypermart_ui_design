        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                // Instead of calling ExclusiveBeautyDealsSection() class multiple times, you can use ListView.separator in the ExclusiveBeautyDealsSection() class
                ...
                // or you can create a list of type String(or any other type) of items you want to display
                // on the UI (like images ) in your class then you can pass itemCount as images.length.
